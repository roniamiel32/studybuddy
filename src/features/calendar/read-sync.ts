 ...
 *
 *              COMMENTED OUT IN FULL — 2026-09-01. Reading a calendar needs
 *              `calendar.readonly`, which is a sensitive scope, and this app
 *              now asks Google for nothing at all.
 * Version:     0.50.0
 *
 * Modifications:
 *     0.50.0 - 2026-09-01 - Disabled in full, with the rest of the integration
 *     0.49.0 - 2026-09-01 - The write-back at the end of a sync is commented
 *                           out; the read half is untouched
 *     0.46.0 - 2026-08-18 - Initial implementation (two-way calendar sync)
 */

/*
 * DISABLED IN FULL — 2026-09-01. See the note at the top of
 * src/lib/google/calendar.ts. Availability is drawn by hand again, which is
 * what the grid in onboarding step 4 and on the Profile tab has always done.
 */
...
// /* DISABLED — 2026-09-01, with the rest of the write sync. See the note at the
//    top of src/features/calendar/write-sync.ts.
//
...
//    *
//    * DISABLED — 2026-09-01. This app writes nothing into Google now.
//    *
