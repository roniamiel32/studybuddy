 ...
 *
 *              COMMENTED OUT IN FULL — 2026-09-01. startCalendarConnect is the
 *              one place that ever built a consent URL, so it is the place this
 *              pass had to reach: with it gone, no student can be sent to
 *              Google's consent screen at all.
 * Version:     0.50.0
 *
 * Modifications:
 ...
 *
 * The 'use server' directive is commented out with the rest: an empty module is
 * not a server-action module, and leaving the directive on a file that exports
 * nothing is a promise about a boundary that no longer exists.
 */
