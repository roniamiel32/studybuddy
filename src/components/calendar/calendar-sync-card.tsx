 ...
 *
 *              COMMENTED OUT IN FULL — 2026-09-01. Both of the screens that
 *              rendered it — onboarding step 4 and the Profile tab — have their
 *              own commented-out block where it used to sit.
 * Version:     0.50.0
 *
 * Modifications:
 ...
 * src/lib/google/calendar.ts. The Connect button this card carried was the only
 * way into Google's consent screen from the product.
 */
